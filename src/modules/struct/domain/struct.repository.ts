import { StructEntity } from './struct.entity';
...
export namespace StructRepository {
  ...
  export interface Repository extends IRepository<StructEntity, FindParams, FindAllParams> {
